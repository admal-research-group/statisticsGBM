...
In this document, we discuss its modified version that is used for the subsequent study on the influence on grain
boundary character anisotropy and grain statistics in two-dimension. 
