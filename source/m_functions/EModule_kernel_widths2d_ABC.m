function [alpha,beta] = EModule_kernel_widths2d_ABC(distinctOri,option)

% Estimates the characteristic widths of two Gaussian kernels. Because grain boundary energy functions are higly restricted, this is much simpler than the previous one. 
...
elseif(option==-1) % read shockley energy...
